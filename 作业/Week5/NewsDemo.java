...
public class NewsDemo {
	public static void main(String[] args) {
        ...
        Listener anonymousClassListener = new Listener(){
            public void newsArrived(NewsEvent e)
			{
                System.out.println("Anonymous class implementation!");
                if(e.level>5) 
                {
                    System.out.println("warning from " + e.source + " :" );
                }
                System.out.println("please note," + e.text + " happened!");
            }
        };

        bbc.addListener(anonymousClassListener);
        
        Listener lambdaListener = (e) -> {
        ...
        bbc.addListener(lambdaListener);
