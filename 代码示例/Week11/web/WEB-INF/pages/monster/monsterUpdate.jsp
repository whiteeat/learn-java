...
<form:form action="monsters" method="post" modelAttribute="monster">
    妖怪名字:<form:input path="monsterName" value="${requestScope.monster.monsterName}"/> <form:errors
        path="monsterName"></form:errors><br><br>
    妖怪电邮:<form:input path="email" value="${requestScope.monster.email}"/><form:errors
        path="email"></form:errors><br><br>
